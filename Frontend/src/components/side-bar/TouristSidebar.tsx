...
const TouristSidebar: React.FC = () => {
  ...
  const menuItemsTop = [
    { text: "Home", path: "/tourist/home", icon: <HomeIcon /> },
    { text: "Explore Guides", path: "/tourist/explore", icon: <ExploreIcon /> },
    { text: "My Trips", path: "/tourist/trips", icon: <TripsIcon /> },
    { text: "Bookings", path: "/tourist/bookings", icon: <BookingIcon /> },
  ];

  const menuItemsBottom = [
    { text: "My Profile", path: "/tourist/profile", icon: <ProfileIcon /> },
  ];
