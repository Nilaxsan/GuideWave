...
const TouristTopBar: React.FC<TouristTopBarProps> = ({
  userName = "Alice Doe",
  userAvatar,
}) => {
  ...
  const getPageTitle = () => {
    ...
    switch (path) {
      case "/tourist/home":
        return "Home";
      case "/tourist/explore":
        return "Explore Guides";
      case "/tourist/trips":
        return "My Trips";
      case "/tourist/bookings":
        return "Bookings";
      case "/tourist/favorites":
        return "Favorites";
      case "/tourist/profile":
        return "My Profile";
      case "/tourist/support":
        return "Support";
      default:
        return "Tourist Portal";
    }
  };
      ...
      >
        ...
        <Box sx={{ flex: 1, maxWidth: 400, mx: 4 }}>
          <TextField
            fullWidth
            size="small"
            placeholder="Search destinations, guides, or trips..."
            value={searchQuery}
